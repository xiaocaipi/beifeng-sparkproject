...
//		return actionDF.javaRDD().repartition(1000);
	...
	public static JavaPairRDD<String, Row> getSessionid2ActionRDD(JavaRDD<Row> actionRDD) {
		 ...
		 * 
		 * 如果是个javardd<object1>.mapToPair
		 * PairFunction 的输入是个 object1
		 * 
		 * 如果是个JavaPairRDD<object1,object2>.mapToPair
		 * PairFunction 的输入是个 Tuple2<object1,object2>
		 */
...
//				});
	...
	private static JavaPairRDD<String, String> filterSessionAndAggrStat(
		...
		JavaPairRDD<String, String> filteredSessionid2AggrInfoRDD = sessionid2AggrInfoRDD.filter(
				//Function  和 PairFunction 一样    input Tuple2<String,String>   返回是个Boolean
